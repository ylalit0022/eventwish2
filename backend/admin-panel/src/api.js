...
// Add missing singular function exports as aliases
export const getTemplate = getTemplateById;
export const getAdMob = getAdMobById;
export const getCategoryIcon = getCategoryIconById;
export const getSponsoredAd = getSponsoredAdById;
export const getUpcomingFestival = getFestivalById;
