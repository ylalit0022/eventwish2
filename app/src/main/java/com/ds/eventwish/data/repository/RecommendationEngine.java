...
public class RecommendationEngine {
    ...
    public List<Template> getPersonalizedRecommendations() {
        ...
        try {
            ...
            // Use getTemplates() which returns LiveData instead of getTemplatesSync()
            LiveData<List<Template>> templatesLiveData = templateRepository.getTemplates();
            if (templatesLiveData.getValue() != null) {
                allTemplates.addAll(templatesLiveData.getValue());
            }
