...
public class TemplateRenderer {
    ...
    public void renderTemplate(Template template) {
        ...
        renderTemplate(html, css, js);
    }

    /**
     * Render a template with separate HTML, CSS, and JS
     * @param html The HTML content
     * @param css The CSS content (can be null)
     * @param js The JavaScript content (can be null)
     */
    public void renderTemplate(String html, String css, String js) {
        if (listener != null) {
